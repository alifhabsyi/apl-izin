    ...
    <div class="book">
        ...
        <table width="100%">
            ...
            <div class="subpage">
                ...
                <br>
                Untuk &nbsp;&nbsp;: Melaksanakan Survei dan Identifikasi lapangan terhadap permohonan Izin Jasa
                Konstruksi a.n. :
                <br>
                <table>
                    <tr>
                ...
                Tujuan : &nbsp;&nbsp;Melengkapi persyaratan Pembuatan Izin Jasa Konstruksi
                <br>
        ...
        <table width="100%">
            ...
            <div class="subpage">
                ...
                Pada hari ini,
                <?php echo $TGL_ST ?>
                Berdasarkan Surat Perintah Tugas Survei dan Identifikasi Lapangan Kepala DPMPTSP Kota Banjarmasin No. <?php echo $NO_BAP ?> 
                <?php echo $NO_BAP ?> tanggal
                <?php echo $TGL_ST ?>, telah dilaksanakan peninjauan lapangan untuk survey dan identifikasi lapangan terhadap permohonan Izin Jasa Konstruksi, Dokumen No.
