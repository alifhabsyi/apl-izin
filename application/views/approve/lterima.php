<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form class='form-horizontal' id='submit' action="<?php echo base_url() ?>admin/lterima" method='post' enctype='multipart/form-data'>
                            ...
                            <?php
                               if ($this->input->post("tahun")) {
                                ...
                                $bulan=$this->input->post("bulan");
                                   ...
                                   $url= base_url()."admin/export_lterima?t=$tahun&b=$bulan";
                                   $burl= base_url()."admin/export_clterima?t=$tahun&b=$bulan";
                               }
