                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <?php
                                                    if($a->STATUS=="APV"){
                                                ?>
                                                <a href="<?php echo base_url()?>admin/approvest?n=<?php echo $a->ID_REG?>" class="btn btn-link btn-warning edit"><i class="fa fa-check"></i></a>
                                                <?php } else{ ?>
                                                    <a href="<?php echo base_url()?>admin/editst?n=<?php echo $a->ID_REG?>" class="btn btn-link btn-warning edit"><i class="fa fa-edit"></i></a>
                                                    
                                                    <?php } ?>
                                                <?php 
                                                    if($a->STATUS=="STBAP" && $a->JENIS=="lab"){?>
                                                        <a href="<?php echo base_url()?>admin/pstlab?n=<?php echo $a->ID_REG?>" class="btn btn-link btn-warning edit"><i class="fa fa-print"></i></a>
                                                    <?php
                                                    }else if($a->STATUS=="STBAP" && $a->JENIS=="pend"){?>
                                                        <a href="<?php echo base_url()?>admin/pstpend?n=<?php echo $a->ID_REG?>" class="btn btn-link btn-warning edit"><i class="fa fa-print"></i></a>
                                                    <?php
                                                    }else if($a->STATUS=="STBAP" && $a->JENIS=="kons"){?>
