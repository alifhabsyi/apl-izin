            ...
            <div class="content">
                <div class="container">
                    <div class="card card-register card-plain text-center">
                            ...
                            <div class="row  justify-content-center">
                                <div class="col-md-8">
                                    <div class="header-text">
                                        <h2 class="card-title">Permohonan Izin Usaha Jasa Konstruksi</h2>
                                        <h4 class="card-subtitle">Form Pendaftaran Izin Usaha Jasa Konstruksi</h4>
                                        <hr />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body ">
                            <form class='form-horizontal' id='submit' action="<?php echo base_url(); ?>register/upload3" method='post' enctype='multipart/form-data'>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <label style="color:white" for="">FOTO</label>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <input type="file" class="form-control" required name="ktp" id="ktp">
                                                </div>
                                                <div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <label style="color:white" for="">IUJK</label>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <input type="file" class="form-control" required name="iujk" id="iujk">
                                                </div>
                                                <div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <label style="color:white" for="">SBUJK</label>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <input type="file" class="form-control" required name="sbujk" id="sbujk">
                                                </div>
                                                <div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-5">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <label style="color:white" for="">NPWK</label>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <input type="file" placeholder="" class="form-control" required name="npwk" id="npwk">
                                                </div>
                                                <div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <input type="file" placeholder="" class="form-control" required name="sktu" id="sktu">
                                                </div>
                                                <div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <label style="color:white" for="">Sertifikat Keahlian</label>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <input type="file" placeholder="" required class="form-control" name="sertifikat_keahlian" id="sertifikat_keahlian">
                                                </div>
                                                <div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <label style="color:white" for="">Daftar Pengalaman</label>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <input type="file" placeholder="" required class="form-control" name="daftar_pengalaman" id="daftar_pengalaman">
                                                </div>
                                                <div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <label style="color:white" for="">PJT</label>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <input type="file" placeholder="" required class="form-control" name="PJT" id="PJT">
                                                </div>
                                                <div>
                                                </div>
                                            </div>
