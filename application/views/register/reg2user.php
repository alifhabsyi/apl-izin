                    ...
                    <div class="card card-register card-plain text-center">
                            ...
                            <div class="row  justify-content-center">
                                <div class="col-md-8">
                                    <div class="header-text">
                                        <h2 class="card-title">Permohonan Izin Sektor Pendidikan</h2>
                                        <h4 class="card-subtitle">Form Pendaftaran Izin Usaha - Komersil (OPERASIONAL)</h4>
                                        <hr />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input type="hidden" name="jenis" id="jenis" value="pend" <div class="content">

                                    <div class="form-group">
                                        <input type="text" placeholder="Nama Lembaga" class="form-control" name="nama" id="nama">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" placeholder="Alamat Lembaga" class="form-control" name="alamat" id="alamat">
                                    </div>
                                    <div class="form-group">
